...
set :project, 'bonitz' # the GitHub project name
set :github_user, "mergeweb" # Your GitHub username
set :domain_name, "bonitz.com" # should be something like project.mydomain.com
set :user, 'merge' # VPS hosting ssh username
set :domain, 'mario.mergeweb.net' # IP or domain name to ssh to
...
set :applicationdir, "/var/www/vhosts/mergeweb.com/httpdocs/#{domain_name}"
set :keep_releases, 3
